...
ARCHITECTURE struct OF decodeStage IS
   ...
   SIGNAL F2                    : STD_LOGIC;
   SIGNAL R7                    : LC3B_REG;
   SIGNAL R8                    : LC3B_NIBBLE;
   SIGNAL SrcA                  : LC3B_REG;
   SIGNAL SrcAMuxOut            : LC3B_REG;
   ...
   SIGNAL use_ghost_reg         : STD_LOGIC;
...
BEGIN
   ...
   decode_control_out <= decode_control_buffer;

   -- HDL Embedded Text Block 8 eb8
   R8 <= "1000";
   use_ghost_reg <= decode_control_buffer.dec.use_ghost_reg;
