...
ARCHITECTURE struct OF memStage IS
   ...
   SIGNAL mem_data_in_buffer : LC3B_WORD;
...
BEGIN
   ...
   Dataout <= src_b;
   mem_data_in <= mem_data_in_buffer;
   mem_data_in_buffer <= DATAIN;
   addr_low_bit <= mem_aluout(0);

   -- HDL Embedded Text Block 2 eb2
   mem_data_out <= mem_data_in1;
   mem_data_out.mem_data_in <= mem_data_in_buffer;
   
   src_b <= mem_data_in1.sr2_val;
