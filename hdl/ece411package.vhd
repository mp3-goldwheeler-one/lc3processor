...
-- DATAPATH SIGNAL WIDTHS
	...
	SUBTYPE LC3B_TRISTATE_2MUX_SEL  IS STD_LOGIC_VECTOR(1 downto 0);
  SUBTYPE LC3B_TRISTATE_4MUX_SEL  IS STD_LOGIC_VECTOR(3 downto 0);
  SUBTYPE LC3B_TRISTATE_8MUX_SEL  IS STD_LOGIC_VECTOR(7 downto 0);
...
--CACHE SIGNALS (ADD MORE TO ME!!)
  ...
  subtype LRU_8_Section is std_logic_vector(2 downto 0);
	...
	CONSTANT HALF_CLOCK_PERIOD  : TIME := 15 NS;
  ...
  CONSTANT hiz_mem_control : mem_control_word := (
	...
	-- "1111XXX"
	CONSTANT trap_instr : control_word := (
		dec   => (
			ldi           => '0',
			sti           => '0',
			jsr           => "01",
