...
ARCHITECTURE struct OF Datapath IS
   ...
   SIGNAL uarch_stall_out        : std_logic;
...
BEGIN
   ...
   -- bubble control
   exec_insert_bubble <= stall_load_use_buffer;                                       
   ...
   aUArch : uarch
      PORT MAP (
         ...
         uarch_stall_out    => uarch_stall_out
      );
