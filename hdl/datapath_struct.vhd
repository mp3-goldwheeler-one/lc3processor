...
BEGIN
   ...
   decode : decodeStage
      PORT MAP (
         ...
         decode_num_bits   => decode_num_bits,
         decode_opcode     => decode_opcode,
         decode_ready      => decode_ready,
         decode_regwrite   => decode_regwrite,
         decode_sext_imm   => decode_sext_imm,
