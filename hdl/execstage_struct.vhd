...
ARCHITECTURE struct OF execStage IS
   ...
   SIGNAL jsrr_or_jmp       : STD_LOGIC;
   SIGNAL load_pc           : STD_LOGIC;
   SIGNAL mem1_aluout       : LC3B_WORD;
   SIGNAL mem2_aluout       : LC3B_WORD;
   SIGNAL mem2_mem_data     : LC3B_WORD;
   SIGNAL mem_data_in1      : lc3b_word;
   SIGNAL n_match           : std_logic;
   SIGNAL new_target_pc     : LC3B_word;
...
BEGIN
   ...
   --for forwarding
   mem1_aluout   <= mem1_data_in.aluout;
   mem2_aluout   <= mem2_data_in.aluout;
   mem2_mem_data <= mem2_data_out.mem_data_in;
   wb_data       <= wb_data_in.wb_data;
   
   wb_cc  <= wb_data_in.cc;
   
   exec_control_buffer <= exec_control_in;

   -- HDL Embedded Text Block 3 eb3
   target_pc_mux_sel <= br & take_branch;
   jsrr_or_jmp <= exec_control_in.jsrr_or_jmp;
   ...
   U_12 : PipeDataCombiner
      PORT MAP (
         ...
         nzp         => nzp,
         cc          => fwd_cc,
         target_pc   => new_target_pc,
         taken       => take_branch,
         btb_data    => btb_data,
         wb_data     => exec_wb_data,
