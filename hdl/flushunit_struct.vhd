...
BEGIN
   ...
   mem1_flush_l  <= mem_mismatch_l;
   mem2_flush_l  <= mem_mismatch_l;
   
   exec_flush    <= flush_exec;
   uarch_flush   <= flush_exec;
   exec_flush_l  <= flush_exec_l;
   uarch_flush_l <= flush_exec_l;
   
   fetch2_flush   <= flush_fd;
   decode_flush   <= flush_fd;
   fetch2_flush_l <= flush_fd_l;
   decode_flush_l <= flush_fd_l;
