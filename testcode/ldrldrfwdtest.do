echo "--- Executing initialization force file for ../testcode/ldrldrfwdtest.asm ---"
...
echo "Done initializing processor, loading ../testcode/ldrldrfwdtest.asm program code."
run 5
...
change /cpu/dram/pdram/vhdl_memory/mem(10) X"D2"
change /cpu/dram/pdram/vhdl_memory/mem(11) X"61"
...
run 5
echo "Done loading ../testcode/ldrldrfwdtest.asm program code."
