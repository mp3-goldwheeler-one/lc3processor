...
RandLoop:
	...
	lea R7, SpotCheck;
	ldi R0, R7, SpotCheck[0]$BASEREL;
	ldi R1, R7, SpotCheck[1]$BASEREL;
	ldi R2, R7, SpotCheck[2]$BASEREL;
	ldi R3, R7, SpotCheck[3]$BASEREL;
	ldi R4, R7, SpotCheck[4]$BASEREL;
	ldi R5, R7, SpotCheck[5]$BASEREL;
	ldi R6, R7, SpotCheck[6]$BASEREL;
	ldi R7, R7, SpotCheck[7]$BASEREL;
